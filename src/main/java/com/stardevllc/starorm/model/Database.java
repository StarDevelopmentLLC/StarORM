...
import com.stardevllc.starorm.StarORM;
import com.stardevllc.starorm.interfaces.ObjectConverter;
import com.stardevllc.starorm.statements.JoinType;
import com.stardevllc.starorm.statements.SqlSelect;
import com.stardevllc.starorm.statements.WhereClause;
...
public class Database {
    ...
    public Set<ObjectConverter> getObjectConverters() {
        ...
        typeHandlers.addAll(StarORM.DEFAULT_TYPE_HANDLERS);
        if (registry != null) {
